...
I bridge the gap between data and business decisions.

Four years inside NTT DATA's enterprise ERP practice — resolving 20–30+ system issues per release cycle, leading cross-functional teams of 10+, translating complex business pain points into structured solutions for Fortune 500 clients — built a ground-level understanding of how processes, data, and stakeholder dynamics interact at scale.

Now at SKK GSB (Seoul), I'm combining that operational foundation with an MBA specializing in **AI & Business Analytics** and **Marketing Analytics** — building toward consulting, strategy, and analytics roles where analytical thinking drives commercial outcomes.
